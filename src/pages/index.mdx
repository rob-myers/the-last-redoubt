...
This blog is all about programming Non-Player Characters ([NPCs](https://en.wikipedia.org/wiki/Non-player_character)).
An NPC is a character in a video game e.g. a human, robot or animal.
