...
awaitWorld # World tab must be visible

# ${ansiColor.Reverse}we've loaded shell functions${ansiColor.Reset}
# ${ansiColor.Reverse}and connected to the world at $WORLD_KEY${ansiColor.Reset}

choice 'tap to [continue](-)'

spawn foo '{x:-89.8,y:1075.7}'
npc set-player foo
view 2000 '{x:-89.8,y:1075.7}' 2

# ${ansiColor.Reverse}we've spawned an npc, set them as player${ansiColor.Reset}
# ${ansiColor.Reverse}and are now viewing them${ansiColor.Reset}

choice 'tap to [continue](-)'

npc map hide

# ${ansiColor.Reverse}we've hidden map the overlay${ansiColor.ReverseReset}
