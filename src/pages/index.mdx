...
We want to make video games more meaningful. That is the objective of this website. Video games suffer from an underlying problem: **simplistic character behaviour** (NPC as a [meme](https://en.wikipedia.org/wiki/NPC_(meme))). Exceptional games have circumvented this, some recent examples being:
