...
Consider our shell function `call`.

> Given a textual description of a JavaScript function and its arguments, `call` creates the JavaScript function and its arguments, and finally invokes this function with these arguments.
