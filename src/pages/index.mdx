...
1. Explicitly build and combine [NPC](https://en.wikipedia.org/wiki/Non-player_character) behaviours.
...
1. Use openly available assets:
    ...
    - Robert Brook's [Top down men game asset character pack](https://www.gamedeveloperstudio.com/graphics/viewgraphic.php?page-name=Top-down-men-game-asset-character-pack&item=1r6d547z6f232v871n). <SideNote>Not free but only `$14.95` with the [Spriter](https://brashmonkey.com/spriter-pro/) source files.</SideNote>

{/* These assets themselves embody [Traveller RPG](https://en.wikipedia.org/wiki/Traveller_(role-playing_game)). */}


The first thing to say is that we're tackling the problem head on.
