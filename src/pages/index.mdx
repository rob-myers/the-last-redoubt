...
<Def title="world">
  ...
  Its [state](https://github.com/rob-myers/the-last-redoubt/blob/staging/src/projects/world/World.jsx#:~:text=const%20state "@new-tab") is stored under `worldKey` in an application-wide [cache](https://tanstack.com/query/v4/docs/react/reference/QueryClient "@new-tab")l. This external API is denoted `api`.
