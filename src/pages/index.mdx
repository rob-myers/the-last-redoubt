...
To create our first NPC behaviour we'll need:
- a **Player** (some chosen character _observing_ the behaviour).
- an **NPC** (another character _performing_ the behaviour).
- a **World** they inhabit (geomorphs connected together).
