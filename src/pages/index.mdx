...
Recall our motivation i.e. understanding and improving Game AI.
Rather than providing independent parallel systems,
we'll intentionally modify the Player's experience, e.g.
...
It is relevant to a wide audience: web developers and also video game enthusiasts.
...
we know no alternative other than embedding into a video game.
...
> Cartesius encourages him to ordain into the 320 temples of the Upper Pyramid.
...
Articles up next:
- **Setup** -- _how we built what we've built_.
- **JS CLI** -- _introducing our online JavaScript Command Line Interface_.
- **Baby steps** -- _applying the JS CLI to Game AI_.
