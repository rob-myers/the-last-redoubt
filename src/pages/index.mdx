...
We want to make video games more meaningful; that is the objective of this website.
We believe video games provide a chance to better understand ourselves and others.
Sadly, they have become synonymous with meaningless violence, bad storytelling and simplistic character behaviour.
Numerous exceptions exist e.g. [What Remains of Edith Finch](https://en.wikipedia.org/wiki/What_Remains_of_Edith_Finch) and [The Last of Us Part II](https://en.wikipedia.org/wiki/The_Last_of_Us_Part_II) <SideNote>Admittedly the latter is particularly violent, but not in the usual meaningless way.</SideNote>.
...
But what about another approach?

Meaningless violence and bad storytelling may actually be side-effects of simplistic character behaviour. If the behaviour was more sophisticated it could play the role of storyteller. If the behaviour was richer the game-mechanic needn't revolve around violence alone. But how can we develop more sophisticated character behaviour?
We have three core ideas.

> Canonical visual representations via HTML and CSS.

> Canonical scripting via POSIX syntax interpreted as JavaScript.

> A rich setting ([Traveller RPG](https://en.wikipedia.org/wiki/Traveller_(role-playing_game))) with thousands of free assets (Robert Pearce's [Starship Geomorphs](http://travellerrpgblog.blogspot.com/2020/07/starship-geomorphs-20.html)).

The 1st and 2nd point are concerned with the programmatic implementation.
The 3rd point sets the style: _top-down perspective_, the non-character assets: _Starship Geomorphs_, and provides a pool of ideas we can draw from: _Traveller RPG_.
