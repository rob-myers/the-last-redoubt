...
Crucially, they are not controlled by the Player.
In one approach the Player interacts with an ongoing simulation.
In another, the Game fabricates reality in response to the Player.
