...
Both meaningless violence and bad storytelling may actually be _side-effects_ of simplistic character behaviour. If the behaviour was more sophisticated it could help tell the story, and the game-mechanic needn't revolve around violence. But how to develop more sophisticated character behaviour?
...
Then we'll approach the problem directly by creating and combining many behaviours for their own sake (usually Game AI is beholden to its parent video game).
