...
1. The [Traveller universe](https://en.wikipedia.org/wiki/Traveller_(role-playing_game)) provides the background context.<SideNote>The concept of _Starship Geomorph_ comes from Traveller.</SideNote>
Additionally we adopt a narrative container called _The Experiment_.
