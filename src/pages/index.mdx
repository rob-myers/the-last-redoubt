...
1. Use openly available assets:
    - Robert Pearce's [Starship Geomorphs](http://travellerrpgblog.blogspot.com/2020/07/starship-geomorphs-20.html "@new-tab") and Eric Smith's [PNGs](http://ericbsmith.no-ip.org/geomorphs/ "@new-tab").
...
By contextualising the behaviour within [Traveller RPG](https://en.wikipedia.org/wiki/Traveller_(role-playing_game)) we'll avoid a dry abstract approach.
