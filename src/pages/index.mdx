...
As far as more meaningful video games are concerned, behaviour is the main blocker. 
Both meaningless violence and bad storytelling may actually be _side-effects_.
If the behaviour was more sophisticated it could help tell the story,
...
<Aside title="clarify-sophisticated-behaviour">
  Technically these have all been done before,
  ...
  {/* Video games have more than just NPC behaviour to contend with.
  As things stand, it seems a better Player experience arises by tightening the narrative.
  Maybe we need to focus on character behaviour in and of itself.  */}
</Aside>

But how are we going to create more sophisticated behaviour? We have a few core ideas.
