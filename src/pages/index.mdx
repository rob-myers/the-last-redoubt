...
Both meaningless violence and bad storytelling may actually be _side-effects_ of simplistic character behaviour. If the behaviour was more sophisticated it could help tell the story, and the game-mechanic needn't revolve around violence.
...
1. Use openly available assets:
    - Robert Pearce's [Starship Geomorphs](http://travellerrpgblog.blogspot.com/2020/07/starship-geomorphs-20.html "@new-tab") and Eric Smith's [PNGs](http://ericbsmith.no-ip.org/geomorphs/).
...
<Carousel
  ...
  items={[
    ...
    { src: 'npcs-2.png', webp: 'npcs-2.webp', label: 'Each World is driven by one or more Terminals.' },
  ]}
/>
