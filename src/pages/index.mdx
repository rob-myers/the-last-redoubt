...
A typical website amounts to a deep oft-mutated [DOM-tree](https://en.wikipedia.org/wiki/Document_Object_Model) initially induced by HTML, brought to life _visually_ via referenced CSS and _interactively_ via referenced JavaScript<SideNote>Technically, JavaScript permits arbitrary DOM mutation.</SideNote>.
