...
1. Develop differently:
    ...
    - In-browser scripting by interpreting [POSIX](https://pubs.opengroup.org/onlinepubs/9699919799/utilities/V3_chap02.html#tag_18) syntax as JavaScript.
...
Then the next step is a World with a Player.
