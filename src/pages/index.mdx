...
<Aside title="mobile-tty-touch-menu">
  `<Terminal>` has a helpful side-menu (\<).
</Aside>
...
We're finally ready to start creating NPC (Non-Player Character) behaviours.
The bare minimum is a World, the Player and a single additional character.
