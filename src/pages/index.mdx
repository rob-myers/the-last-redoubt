...
| date | change |
| --- | ----------- |
| 2022-10-01 | <InnerTable style={{padding:0}}><><>created page</><>[Home page](/), [Introduction](/intro/intro), [About](/about)</></><><>created stub</><>[Setup](/intro/setup), [JavaScript CLI](/intro/js-cli), [Game AI CLI](/intro/ai-cli)</></></InnerTable> |
