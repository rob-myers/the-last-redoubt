...
But what about the World's internal state _AKA_ external `api`?
Let us first define NPC and Player.
...
<Def title="npc">
  ...
  instantiated inside [`<NPCs>`](https://github.com/rob-myers/the-last-redoubt/blob/staging/src/projects/world/NPCs.jsx "@new-tab").
