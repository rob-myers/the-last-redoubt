...
In those early days anything seemed possible.
Nowadays, NPC has even become [an insult](https://en.wikipedia.org/wiki/NPC_(meme)).

Concerning the current state of affairs, we'll try to remain silent.
Video games have their own metrics of success.
We're going to study NPCs for their own sake, but how?
🚧
