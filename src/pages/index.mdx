...
POSIX-based CLIs are heavily used in e.g. home computing, development environments and cloud computing.
...
Composing these two technologies avoids all sorts of UI decisions, for which there is no right answer.
