...
Concerning simplistic character behaviour,
...
We are going to create and combine character behaviours.
But what actually _is_ a character behaviour?
Answering this question requires some underlying concepts, i.e.
