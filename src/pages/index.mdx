...
The geomorphs should arranged so each hull door either (a) touches nothing else, (b) coincides with exactly one other hull door.
...
<Aside title="mobile-tty-touch-menu">
  `<Terminal>`s have a helpful side-menu: `<`.
</Aside>
