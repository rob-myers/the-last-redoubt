...
Video games have great potential e.g. they provide a chance to better understand ourselves.
...
<Carousel
  ...
  items={[
    { src: 'npcs-1.png', webp: 'npcs-1.webp', label: 'The Player and some NPCs' },
    { src: 'npcs-2.png', webp: 'npcs-2.webp', label: 'The Player and some NPCs' },
  ]}
/>
...
So much for generality, but will it actually be _entertaining_?
