...
Entertainment will arise by building and interacting with a little world.
As the complexity of these fabrications increases, so will our satisfaction.
Finally, by contextualising the behaviour within Traveller RPG we'll avoid abstraction.
