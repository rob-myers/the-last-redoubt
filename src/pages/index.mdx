...
We want to program NPCs -- in fact, we'd like to produce a catalogue of interesting behaviours, and study how they can be composed in response to the Player's actions.
...
It is usually brought to life via assets representing a specific situation: animations of denizens and suitable scenery.

🚧 Although we definitely need this "spice", we can still try to keep things generic.
