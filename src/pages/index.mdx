...
Video games provide a chance to better understand ourselves and others.
However, they have become synonymous with meaningless violence, bad storytelling and simplistic character behaviour.
Isolated exceptions certainly exist e.g. [What Remains of Edith Finch](https://en.wikipedia.org/wiki/What_Remains_of_Edith_Finch) and [The Last of Us Part II](https://en.wikipedia.org/wiki/The_Last_of_Us_Part_II).
These games overcome **simplistic character behaviour** via a tight narrative.
_What Remains_ has many loosely linked mini-games,
whereas _The Last of Us_ has many sequentially constrained scenarios.
