...
NOECHO=1 choice "So far, this profile has:
- defined shell functions
- connected to a specific world
...
NOECHO=1 choice "Next, we've:
- spawned an npc \\"rob\\"
- set them as the Player
- brought them into view

${ansi.Bold}try pan-zooming [ see above ](href:#aside--can-pan-zoom-tabs)
${ansi.Bold}and [ continue ](-)"
...
NOECHO=1 echo "Finally, we've:
- faded the map
- setup the Player's controls:
