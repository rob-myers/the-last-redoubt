...
The maps above are actually _Worlds_ i.e. [World.js](https://github.com/rob-myers/the-last-redoubt/blob/staging/src/projects/world/World.jsx "@new-tab") component instances:
```jsx
<World
  worldKey="world-map-1"
  gms={[
