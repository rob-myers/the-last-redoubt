...
In this particular session this absolute path resolves to a [string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String):
...
POSIX-based CLIs and CSS are two technologies used heavily in a vast number of disparate domains.
...
Aligning ourselves to them will help us to avoid creating yet another "interface desert island".
