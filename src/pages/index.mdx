...
The `<canvas>` amounts to an image manipulatable via JavaScript.
...
> Thankfully we can use [Starship Geomorphs](http://travellerrpgblog.blogspot.com/2020/07/starship-geomorphs-20.html "@new-tab"), a large number of aerial-view non-commercial-use assets representing Starships, Space-stations, Space-colonies etc.
...
<Carousel
  ...
  cssFilter="invert(1) sepia(0.5) hue-rotate(90deg)"
  items={[
