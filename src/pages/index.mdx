...
- Our NPC-related shell functions extend the CLI, giving our website its name.
  The latter have generic appeal, e.g. `click`, `spawn`, `look`, `nav`, `walk`, and can be naturally piped:
  ```bash
