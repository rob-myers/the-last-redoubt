...
Without the Player there are no _sensory organs_ and the World reduces to a pan/zoomable map.
...
<Def title="npc-and-player">
  ...
  Finally, the _Player_ is the NPC with key `api.npcs.playerKey`.
