...
Try opening [the couch](/assets/symbol/couch-and-chairs--006--0.4x2.svg "@new-tab") and add `view-source:` as a prefix to the URL.
...
One can see e.g. walls, doors, labels by `view-source:`ing the other SVGs above.
