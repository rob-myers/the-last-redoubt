...
If you [try running the video game](/#demo) and look in the Network tab (also possible [on a Mobile](/assets/pics/demo-network-devtools-mobile.png "@new-tab") via [Eruda](https://github.com/liriliri/eruda)) you'll see geomorph PNGs (`{geomorph}.png`) and geomorph [JSONs](https://en.wikipedia.org/wiki/JSON) (`{geomorph}.json`). 
These are the geomorph assets seen by the end-user.
