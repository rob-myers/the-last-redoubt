...
- <InlineCode>cd</InlineCode> mutates the strings <code>/home/PWD</code> and <code>/home/OLDPWD</code>.
...
- <InlineCode>get</InlineCode> gets a value e.g. <InlineCode>get foo/bar/baz</InlineCode>.
...
- <InlineCode>ps</InlineCode> list running processes (<InlineCode>ps -a</InlineCode> shows all).
- <InlineCode>pwd</InlineCode> outputs the string <code>/home/PWD</code>.
