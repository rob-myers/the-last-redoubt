...
It is worth make some observations about the above videos.

> **The game has a birdseye viewpoint**.
>
> Avoiding game-centric tech rules out 3D graphics.<SideNote title="ignoring e.g. isometric" />
...
>
> Clicks are converted into world coordinates, so a navpath can be computed.
...
>
> How do we restrict the players view?
