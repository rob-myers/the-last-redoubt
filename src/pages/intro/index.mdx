...
It is controlled by the _Director_ (a fancy name we've given ourselves).
...
<aside id="parallel-vs-player-xp">

Technically we could implement parallel systems without making a game,
e.g. a [demo](https://github.com/RafaelKuebler/Flocking) of Craig Reynolds' [boids](http://www.cs.toronto.edu/~dt/siggraph97-course/cwr87/).
But when Game AI is viewed as an interactive protocol between Player and Director,
we need an environment to make things meaningful.
