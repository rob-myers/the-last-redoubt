...
Technically we could investigate AI demos without making a game,
...
we need a setting and a plot to make things meaningful.
...
Levels are randomly generated by connecting "modules" (think Geomorphs).
Finally, the top-down line-of-sight view also provided inspiration.
...
- [_Our JS CLI_](/intro/js-cli) describes our in-browser JavaScript Command Line Interface.
- [_Our Game AI CLI_](/intro/ai-cli) extends our JS CLI with Game AI specific functions.
