...
> Avoiding game-centric tech rules out 3D graphics, although not isometric.
...
They intend to make a game yet make a _game engine_ instead i.e.
the supporting systems sans the unification.
...
Our chosen approach is relevant to a wide audience i.e.
not only game developers, but web developers in general.
...
Implementing convincing NPC behaviour is certainly some kind of Artificial Intelligence.
We needn't identify AI with machine vision or driverless vehicles (amazing as they are).
