...
> We'll use the **everyday techniques** of a Web Developer.
>
> This rules out game-centric technologies like Flash, HTMLCanvas frameworks, CSS 3D transforms, and WebGL.

Importantly, it also makes our approach relevant to a much wider audience.
...
Our chosen overarching narrative will be familiar: we must defend the pyramid from invading "Evil Forces".
...
First things first, try entering `/home/PROFILE` into the terminal.
