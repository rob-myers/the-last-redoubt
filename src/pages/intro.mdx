...
<!-- TODO redo playlist below -->

<iframe width="100%" height="464" src="https://www.youtube.com/embed/videoseries?list=PLTcU-Qpr40X44xR7KCxSnD2twoKMEIIr-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<!-- TODO use Carousel to label certain things that occur in videos -->

Let's take a moment to review what we've just seen.

<Carousel id="first-videos" height={400}>
