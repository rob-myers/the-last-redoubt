...
e.g. assets, animation, level design, scripting, controls, UI, dialogue etc.
Films have inspired a popular unification strategy.
That is, the story and characters (including the Player) sit on the podium,
with everything else playing a supporting role.
But to put Game AI on the podium, we've chosen a different role model:
