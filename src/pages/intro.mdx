...
<!-- TODO shorten via <Icon> -->

Try clicking _interact_ above.
You'll see a few lines then repeated messages "__polling for cached query__".
If you don't then click reset (<span className="icon small-icon inline-icon refresh" />).
At this point click <span className="icon small-icon inline-icon cross-circle" /> in the top right.
