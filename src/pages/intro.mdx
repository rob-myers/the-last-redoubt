...
> Game AI: algorithms and data structures used to control [NPCs](https://en.wikipedia.org/wiki/Non-player_character) in video games.

The acronym NPC stands for Non-Player Character i.e. every character except for the Player.
In video games, NPCs must behave realistically, steadily drawing the Player into the fabrication.
The underlying motivation for this website is lacklustre NPC behaviour in modern video games.
Can we do better? Can we at least understand the problem?

Some believe Game AI should _emerge_ from the right ingredients.
...
> We'll use **everyday web dev tech** e.g. CSS, React, Node.js.
>
