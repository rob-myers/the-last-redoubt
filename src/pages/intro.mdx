...
> Game AI.
>
> The algorithms and data structures used to control [NPCs](https://en.wikipedia.org/wiki/Non-player_character) in video games.

These Non-Player Characters must behave realistically,
steadily drawing the Player into the fabrication.
We want to explain how Game AI works, providing copious examples in the process.
