...
When [prompted](https://en.wikipedia.org/wiki/Command-line_interface#Command_prompt) by a `$`, we may enter textual commands into it and press _enter_ to run them.
...
The terminal lies at the heart of our approach to Game AI. __TODO__
