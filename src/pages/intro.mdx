...
| Influences (Story) | [The Night Land](https://en.wikipedia.org/wiki/The_Night_Land) (1912), [Theravada Buddhism](https://en.wikipedia.org/wiki/Theravada).  |
| Influences (Gameplay) | <table style="font-size:0.95rem; padding: 8px; margin-bottom: 8px"><tr><td> [Teleglitch](https://en.wikipedia.org/wiki/Teleglitch "@new-tab") </td><td> Top-down survival-horror roguelike </td></tr> <tr><td> [Fallout 1, 2](https://en.wikipedia.org/wiki/Fallout_(video_game) "@new-tab") </td><td> Oblique turn-based RPGs </td></tr> <tr><td> [GTA 1, 2](https://en.wikipedia.org/wiki/Grand_Theft_Auto_(video_game) "@new-tab") </td><td> Top-down open-world action games. </td></tr></table> |
