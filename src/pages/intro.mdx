...
Believable NPC behaviour can be viewed as a kind of Artificial Intelligence (lacking an important analogy: the Turing test admits arbitrary textual input).
Nevertheless, we needn't identify AI with _Computer Vision_ or _Driverless Vehicles_ (impressive as they are).
