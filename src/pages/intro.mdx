...
Non-Player Characters must move realistically,
drawing the player into the fabrication.
The resulting "realistic environment" is highly contextual i.e. a particular setting, characters, and desired user experience at a particular time.
