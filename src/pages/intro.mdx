...
Both are achieved via mouse click or screen touch.
The Player is _situated_, with vision limited by their position.
They can peek further afield by panning and zooming.
The videos show some kind of _terminal_.
