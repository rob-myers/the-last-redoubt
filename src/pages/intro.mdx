...
But for anything much beyond [Koopa Troopas](https://en.wikipedia.org/wiki/Koopa_Troopa) or [Boo Diddleys](https://en.wikipedia.org/wiki/Boo_(character)),
...
The Director _directs_ by running commands in a terminal,
including scripts and long-running processes.
For example, each terminal runs an initial script - its _profile_.
