...
What have we seen in the videos?

> **The game has a birdseye viewpoint**.
> Avoiding game-centric tech rules out 3D graphics, although isometric would still be possible.
...
> **The Player interacts by clicking the mouse or touching the screen**.
...
Then our world is in-keeping with our [everyday web dev approach](#intro--tech-stack "@anchor").
