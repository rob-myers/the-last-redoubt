...
3. Finally return to the 1st tab and scroll to the top.
  ...
  | Line | Info |
  | --- | ----------- |
  | `ℹ️  Running /home/PROFILE` | The absolute path <InlineCode>/home/PROFILE</InlineCode> refers to a string i.e. the terminal's initialisation script. Try typing it into the terminal, or click and paste (easier on a mobile). |
