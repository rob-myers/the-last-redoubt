...
We'll develop our game using the _everyday practices_ of the Web Developer.
...
Concerning the underlying game systems, we've already done most of the groundwork.
