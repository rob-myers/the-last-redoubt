...
> Examples of PX (Player Experience) focused approach:
> - Spawn nearby enemies if the Player walks through 3 doors.
> - Build tension by only showing enemies at fringes of sight-polygon.
...
We've made some videos illustrating the example above.
