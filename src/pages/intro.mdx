...
Reading Game AI tutorials, one gets the impression that intelligent behaviour simply emerges from the right ingredients.
...
Focusing on what the Player _actually experiences_ yields a far more successful approach.
...
However, it means we'll need to **create a game** in order to make meaningful Game AI.
