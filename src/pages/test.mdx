...
<Tabs
  ...
  tabs={[
    [
      { type: 'component', class: 'WorldPixi', filepath: 'world-px-1', props: {
        worldKey: 'world-px-1',
        gms: [
          { gmKey: 'g-301--bridge' },
      ...
      { type: 'component', class: 'WorldPixi', filepath: 'world-px-1-alt', props: {
        worldKey: 'world-px-1-alt',
        viewWorldKey: 'world-px-1',
        gms: [],
      }},
