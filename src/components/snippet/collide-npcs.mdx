...
> - Assume A is moving. <SideNote>If $A$ and $B$ are both stationary, test the distance between the circle centers.</SideNote>
> - Let $s_A$ (resp. $s_B$) be the speed of $A$ (resp. of $B$).
> - Let $r_A$ (resp. $r_B$) be the radius of $A$ (resp. of $B$).
