...
const layoutDefs = {
  ...
  "g-303--passenger-deck": {
    ...
    items: [
      ...
      { at: '👉', id: 'galley-and-mess-halls--006--4x2', flip: 'y' },
      { at: '👇', id: 'table--009--0.8x0.8', x: 8, y: 8 },
      { at: '👇', id: 'table--009--0.8x0.8', y: 60 + 8 },

      { id: 'window--001--1x0.2', x: 1 * 60 + 30, y: -6 },
      { at: '👉', id: 'window--001--1x0.2', x: 2 * 60 },
      { at: '👉', id: 'window--001--1x0.2', x: 1 * 60 },
      { at: '👉', id: 'window--001--1x0.2', x: 1 * 60 },
      { at: '👉', id: 'window--001--1x0.2', x: 1 * 60 },
      // { symbol: 'window--001--1x0.2', transform: [1, 0, 0, 1, 870, -6] },

      { id: 'iris-valves--005--1x1', x: 19 * 60, y: 4 * 60, a: 90 },
      { id: 'iris-valves--005--1x1', y: 9 * 60, x: 5 * 60, flip: 'y' },

      { id: 'fresher--002--0.4x0.6', x: 3 * 60 + 20, y: 4 * 60 + 24, flip: 'x' },

      { id: 'gaming-tables--001--2x1', x: 8 * 60 + 2, y: 4 * 60 + 2 },
