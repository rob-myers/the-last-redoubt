...
const layoutDefs = {
  ...
  'g-102--research-deck': {
    ...
    items: [
      ...
      { at: '👉', id: 'ships-locker--007--1x2', flip: 'x', },
      ...
      { at: '👇', id: 'stateroom--012--2x2', a: 90, flip: 'x' },
      { at: '⏪👉', id: 'lab--012--3x4', a: 270 },
      { at: '👉', id: 'lounge--017--2x4', x: 2 * 60 },
      { at: '👇', id: 'fresher--036--2x4', flip: 'x', doors: ['w'] },

      { id: 'misc-stellar-cartography--020--10x10', y: 10 * 60, flip: 'y' },
      { at: '👉', id: 'lab--023--4x4', a: 90,  },
      { at: '👇', id: 'engineering--045--4x6', a: 270 },
      { at: '⏪👉', id: 'lab--023--4x4', x: 2 * 60, a: 90, flip: 'y',   },
      { at: '👇', id: 'lab--030--1x3', y: -1 * 60,  },
