...
/**
 * yarn  render-npc-old {npc-name}
 * yarn  render-npc-old {npc-name} {anim-name-0} ...
 * 
 * Examples:
 * - yarn  render-npc-old first-npc
 * - yarn  render-npc-old first-npc idle
 */
...
if (!npcName || !fs.existsSync(npcSvgFilepath)) {
  error(`usage: yarn  render-npc-old {npc-name} {...anim-name-0} ... where
