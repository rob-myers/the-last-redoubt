...
But how will you make the game?
> Using standard web dev techniques, with emphasis on the declarative nature of HTML and CSS
...
> We've already mentioned standard web development techniques.
...
> Readers can use this CLI to run the demos, inspect internal state, and implement their own behaviours.
